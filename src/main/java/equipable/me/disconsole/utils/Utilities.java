package equipable.me.disconsole.utils;
...
public class Utilities {
    ...
    public static final String PLUGIN_PREFIX = ChatColor.DARK_GRAY + "[" + ChatColor.AQUA + "DisConsole" + ChatColor.DARK_GRAY + "] " + ChatColor.RESET;
    ...
    public static String getColouredString(String string) {
        ...
        if (SKRIPT_EXISTS) {
            while (matcher.find()) {
                ChatColor hexColor = ChatColor.valueOf(matcher.group().substring(1, matcher.group().length() - 1));
